...
const app = Vue.createApp({
  ...
  components: {
    ...
    myHeader: Vue.defineAsyncComponent(() => loadModule('./src/components/myHeader.vue', options)),
  },
...
const Myfooter = Vue.createApp({
  ...
  components: {
    'my-footer': Vue.defineAsyncComponent(() => loadModule('./src/components/footer.vue', options)),
    'my-novo': Vue.defineAsyncComponent(() => loadModule('./src/components/outro.vue', options)),
  },
