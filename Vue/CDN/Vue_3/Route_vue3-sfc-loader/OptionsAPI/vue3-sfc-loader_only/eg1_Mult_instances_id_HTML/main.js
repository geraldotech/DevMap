...
const app = Vue.createApp({
  ...
  components: {
    ...
    myHeader: Vue.defineAsyncComponent(() => loadModule('./components/myHeader.vue', options)),
  },
...
const Myfooter = Vue.createApp({
  ...
  components: {
    'my-footer': Vue.defineAsyncComponent(() => loadModule('./components/footer.vue', options)),
  },
