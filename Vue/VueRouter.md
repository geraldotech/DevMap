...
**Settings :arrow_right: App :arrow_right: Spec :arrow_right:** :arrow_right: `catchall_document: index.html` [thanks John Dave Deploy Your ReactJS](https://www.linkedin.com/pulse/deploy-reactjs-application-digitalocean-john-dave-decano/)
