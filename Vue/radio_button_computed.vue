<template>
  <div>
    <input type="radio" name="tech" value="node" id="node" v-model="tech" />
      ...
      <input type="radio" name="tech" value="javascript" id="javascript" v-model="tech" />
   ...
   <template v-else-if="isHTML">
     <div>
       <img style="max-width:10%" src="https://www.cnet.com/a/img/resize/92ebd806405ac2adf2e2b0f903b5feda822afe21/hub/2011/01/18/5aecbdd4-f0f7-11e2-8c7c-d4ae52e62bcc/HTML5_Logo_550px.png?auto=webp&fit=crop&height=900&width=1200" alt="">
     </div>
   </template>      
